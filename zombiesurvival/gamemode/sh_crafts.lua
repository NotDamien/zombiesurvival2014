...
GM.Crafts = {
	...
	{
		Name = "A modified knife", -- weapons im making
		callback = function(enta, entb)
			return enta:IsPhysicsModel("models/props_junk/metal_paintcan001a.mdl") and entb:IsWeaponType("weapon_zs_swissarmyknife")
		end,
		Result = {"fas2_huncase"}
	}
}
