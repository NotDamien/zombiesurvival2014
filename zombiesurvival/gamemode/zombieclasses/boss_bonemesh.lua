...
function CLASS:CalcMainActivity(pl, velocity)
	if not pl:OnGround() or pl:WaterLevel() >= 3 then
		pl.CalcIdeal = ACT_ZOMBIE_LEAPING -- Set this as the animation if they are NOT on the ground.
	else
		pl.CalcIdeal = ACT_HL2MP_RUN_ZOMBIE_FAST -- Set this as the animation if they ARE on the ground and moving.
	end
