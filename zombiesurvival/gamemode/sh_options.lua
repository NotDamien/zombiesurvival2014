...
GM:AddStartingItem("grenade", "Grenade", nil, ITEMCAT_OTHER, 20, "weapon_zs_grenade")
GM:AddStartingItem("plamagrenade", "Plasma Grenade", nil, ITEMCAT_OTHER, 45, "weapon_plasmanade")
...
GM:AddStartingItem("Armor 50+", "Armor +50", "Increases armor by 50.", ITEMCAT_OTHER, 55, nil, function(ply) ply:SetArmor( ply:Armor() + 50 ) end, "models/combine_vests/bluevest.mdl")
GM:AddStartingItem("Armor 50+", "Armor +75", "Increases armor by 75.", ITEMCAT_OTHER, 75, nil, function(ply) ply:SetArmor( ply:Armor() + 75 ) end, "models/combine_vests/obseletevest.mdl")
GM:AddStartingItem("Armor 50+", "Armor +125", "Increases armor by 125.", ITEMCAT_OTHER, 90, nil, function(ply) ply:SetArmor( ply:Armor() + 125 ) end, "models/combine_vests/bogvest.mdl")
...
GM:AddStartingItem("TANK 50hp", "TANK 50hp", "Increases survivability by increasing maximum health by 50 more.", ITEMCAT_TRAITS, 65, nil, function(pl) pl:SetMaxHealth(pl:GetMaxHealth() + 50) pl:SetHealth(pl:Health() + 50) end, "models/items/healthkit.mdl")
...
GM:AddPointShopItem("uzi", "'Sprayer' Uzi 9mm", nil, ITEMCAT_GUNS, 65, "weapon_zs_uzi")
GM:AddPointShopItem("shredder", "'Shredder' SMG", nil, ITEMCAT_GUNS, 90, "weapon_zs_smg")
GM:AddPointShopItem("bulletstorm", "'Bullet Storm' SMG", nil, ITEMCAT_GUNS, 80, "weapon_zs_bulletstorm")
GM:AddPointShopItem("silencer", "'Silencer' SMG", nil, ITEMCAT_GUNS, 100, "weapon_zs_silencer")
GM:AddPointShopItem("hunter", "'Hunter' Rifle", nil, ITEMCAT_GUNS, 120, "weapon_zs_hunter")

GM:AddPointShopItem("reaper", "'Reaper' UMP", nil, ITEMCAT_GUNS, 90, "weapon_zs_reaper")
GM:AddPointShopItem("ender", "'Ender' Automatic Shotgun", nil, ITEMCAT_GUNS, 100, "weapon_zs_ender")
GM:AddPointShopItem("akbar", "'Akbar' Assault Rifle", nil, ITEMCAT_GUNS, 110, "weapon_zs_akbar")

GM:AddPointShopItem("stalker", "'Stalker' Assault Rifle", nil, ITEMCAT_GUNS, 110, "weapon_zs_m4")
GM:AddPointShopItem("inferno", "'Inferno' Assault Rifle", nil, ITEMCAT_GUNS, 110, "weapon_zs_inferno")
GM:AddPointShopItem("annabelle", "'Annabelle' Rifle", nil, ITEMCAT_GUNS, 130, "weapon_zs_annabelle")

GM:AddPointShopItem("crossbow", "'Impaler' Crossbow", nil, ITEMCAT_GUNS, 140, "weapon_zs_crossbow")

GM:AddPointShopItem("sweeper", "'Sweeper' Shotgun", nil, ITEMCAT_GUNS, 150, "weapon_zs_sweepershotgun")
GM:AddPointShopItem("boomstick", "Boom Stick", nil, ITEMCAT_GUNS, 200, "weapon_zs_boomstick")
GM:AddPointShopItem("slugrifle", "'Tiny' Slug Rifle", nil, ITEMCAT_GUNS, 130, "weapon_zs_slugrifle")
GM:AddPointShopItem("pulserifle", "'Adonis' Pulse Rifle", nil, ITEMCAT_GUNS, 180, "weapon_zs_pulserifle")
...
GM:AddPointShopItem("RPG_Round", "RPG Round", nil, ITEMCAT_AMMO, 25, nil, function(pl) pl:GiveAmmo(GAMEMODE.AmmoCache["rpg_round"] or 1, "rpg_round", true) end, "models/entities/rend_grenade/w_model/w_rend_grenade.mdl")



GM:AddPointShopItem("axe", "Axe", nil, ITEMCAT_MELEE, 30, "weapon_zs_axe")
GM:AddPointShopItem("crowbar", "Crowbar", nil, ITEMCAT_MELEE, 35, "weapon_zs_crowbar")
GM:AddPointShopItem("stunbaton", "Stun Baton", nil, ITEMCAT_MELEE, 40, "weapon_zs_stunbaton")
GM:AddPointShopItem("knife", "Knife", nil, ITEMCAT_MELEE, 5, "weapon_zs_swissarmyknife")
GM:AddPointShopItem("shovel", "Shovel", nil, ITEMCAT_MELEE, 45, "weapon_zs_shovel")
GM:AddPointShopItem("sledgehammer", "Sledge Hammer", nil, ITEMCAT_MELEE, 40, "weapon_zs_sledgehammer")


GM:AddPointShopItem("medkit", "Medical Kit", nil, ITEMCAT_TOOLS, 80, "weapon_zs_medicalkit")
GM:AddPointShopItem("medgun", "Medic Gun", nil, ITEMCAT_TOOLS, 55, "weapon_zs_medicgun")
...
GM:AddPointShopItem("resupplybox", "Resupply Box", nil, ITEMCAT_TOOLS, 140, "weapon_zs_resupplybox")
...
GM:AddPointShopItem("Armor 50+", "Armor +50", "Increases armor by 50.", ITEMCAT_OTHER, 60, nil, function(ply) ply:SetArmor( ply:Armor() + 50 ) end, "models/combine_vests/bluevest.mdl")
GM:AddPointShopItem("Armor 50+", "Armor +75", "Increases armor by 75.", ITEMCAT_OTHER, 70, nil, function(ply) ply:SetArmor( ply:Armor() + 75 ) end, "models/combine_vests/obseletevest.mdl")
GM:AddPointShopItem("Armor 50+", "Armor +125", "Increases armor by 125.", ITEMCAT_OTHER, 100, nil, function(ply) ply:SetArmor( ply:Armor() + 125 ) end, "models/combine_vests/bogvest.mdl")
GM:AddPointShopItem("grenade", "Grenade", nil, ITEMCAT_OTHER, 25, "weapon_zs_grenade")
GM:AddPointShopItem("plamagrenade", "Plasma Grenade", nil, ITEMCAT_OTHER, 55, "weapon_plasmanade")
